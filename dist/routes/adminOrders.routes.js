...
adminOrdersRoutes.patch("/:orderId/approve", order_controllers_1.default.approveOrder);
...
adminOrdersRoutes.patch('/:orderId/reject', order_controllers_1.default.rejectOrder);
